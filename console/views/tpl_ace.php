...
<div class="main-container" id="main-container">
    ...
    <script type="text/javascript" src="/assets/admin/ace/js/ace-extra.js"></script>
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <?//= render('ace/public/shortcuts'); ?>

        <?= render('ace/public/left_menu'); ?>
...
<!--            --><?//= render('ace/public/breadcrumbs'); ?>
            <div class="page-content">
                <?//= render('ace/public/style_setting'); ?>

                <?= render('ace/public/page_header'); ?>
