...
class UrlTool{
    ...
    public static function request_get($url, $options = false, $headers = false){
        return static::request($url, 'GET', $options, $headers);
    }
     ...
     * @return bool
     */
    public static function request_post($url, $params, $options = false, $headers = false){
        return static::request($url, 'POST', $params, false, $options, $headers);
    }
