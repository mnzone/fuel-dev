	...
	<script src="/assets/web/js/common.js"></script>    
		...
		<div class="tab_list infoList">
			...
			<h1>
			  <span id="d_title" class="d_title">昌硕年后初四大量招聘普工</span>
			  <span class="d_titico">名企</span></h1>
			<div class="price">
			  <span class="pay" ismoney="true">3000-5000</span>
			  <span class="pay_yy">元/月</span></div>
			<div class="stats_bar">
			  <div class="pub_date">
				<span>发布：</span>
				<span>2017-02-18</span></div>
			  <div class="browse_num">
				<span>浏览：</span>
				<span id="totalcount">16506</span>
				<span>人</span></div>
			</div>
			<a href="javascript:;" class="collect btn_Favorite" tongji_tag="m_detail_job_full_favourite">
			  <span>收藏</span></a>
		  </section>
		  <section class="job_con">
			<ul>
			  <li>
				...
				<span class="attrValue">
				  <a href="http://m.58.com/sh/pugong/" target="_blank">普工</a></span>
			  </li>
			  <li class="req">
			  ...
			  <li>
				...
				<span class="attrValue dizhiValue">
				  <a href="http://m.58.com/sh/zpshengchankaifa/">上海</a>
				  <a href="http://zp.service.58.com/api/urljump?url=http%3A%2F%2Fc.58cdn.com.cn%2Folympia%2Fhtml%2Fmap.html%3Flongitude%3D121.622934%26latitude%3D31.143302" class="position"></a>
				</span>
			  </li>
			...
			<div style="text-align: center;">
				<a href="javascript:;" class="apply" id="contact_apply2" ref="0" tongji_tag="m_detail_job_full_topsqzw">申请职位</a>
	...
	<section class="company">
	  <div class="com">
	    <div class="comWrap">
	      <h2 class="c_tit">
	        <a href="http://qy.m.58.com/m_detail/32659597460491/" tongji_tag="m_detail_job_full_qyml">昌硕科技（上海）有限公司</a></h2>
	      <div class="renzheng">
	    ...
	    <div class="phoneWrap">
	      <a href="javascript:;" id="contact_phone" class="phone num_protect" phoneno="4008113768" tongji_tag="m_detail_job_full_telephonetop">
	        <span>电话</span></a>
	    </div>
	  </div>
	  <a href="javascript:;" class="open_mes btOnepx btOneOpenpx" id="companyShow" tongji_tag="m_detail_job_full_qyxxzhankai">展开信息</a>
	</section>
	...
	<section class="dcompany_open" id="openCom" style="display: none;">
	  ...
	  <div class="company_con btOnepx">
	    <ul>
	      <li>
	        <span class="attrName">规模：</span>
	        <span class="attrValue">1000人以上</span></li>
	      <li>
	        <span class="attrName">性质：</span>
	        <span class="attrValue">上市公司</span></li>
	      <li>
	        <span class="attrName">行业：</span>
	        <span class="attrValue">
	          <a href="http://qy.m.58.com/m_entlist/246/" target="_blank">计算机硬件+电子技术/半导体/集成电路+多元化集团</a></span>
	      </li>
	      <li>
	        <span class="attrName">地址：</span>
	        <span class="attrValue dizhiValue">上海市浦东新区康桥镇秀沿路3668号昌硕科技上海有限公司
	          <a href="http://zp.service.58.com/api/urljump?url=http%3A%2F%2Fc.58cdn.com.cn%2Folympia%2Fhtml%2Fmap.html%3Flongitude%3D121.62902094571793%26latitude%3D31.13702578543896" class="position"></a></span>
	      </li>
	      <a href="http://qy.m.58.com/m_detail/32659597460491/">
	        <img class="c_logo" src="http://pic.58.com/enterprise/mingqi/n_v1bkuymc4to2ufkjmdhqoa_160_120.jpg"></a>
	      <p>昌硕科技（上海）有限公司座落于上海浦东新区康桥工业园,占地面积3200 亩。于2004年9月于2004年9月投资成立，总投资6.27亿美元，母公司和硕联合科技股份有限公司。昌硕科技（上海）有限公司主要从事平板计算机、手机等高科技电子产品的研发与制造业务。昌硕科技自2006年正式投产以来，呈现稳步发展之态，产值及出口额逐年上升。2012年出口额153亿美金，产值966亿人民币，位居全国出口200强企业第4位，上海市排名第2位，浦东新区排名第1位，2014年位居《财富》全球500强第375位。
	        ...
	        <br>我们相信人才是企业发展最核心的因素，我们欢迎崇本务实的有识之士加入昌硕，我们愿意成为您职业生涯的起跑线，在上海这个国际化的大都市，让和硕与您的梦想共同启航！</p></ul>
	  </div>
	  <a href="javascript:;" class="close_mes btOnepx btOneClosepx" id="companyHide" tongji_tag="m_detail_job_full_qyxxshouqi">收起信息</a>
	</section>
	<!-- 岗位信息介绍 -->
	<section class="pos">
		<div class="position_dis">
		  	<div class="tit bbOnepx"><h2>职位简介</h2></div>
			<div class="dis_con" style="max-height: 89px;">
